...
- [EPIC-006](../epics/EPIC-006-work-item-lifecycle-maturation.md) — ELABORATED — Work Item Lifecycle Maturation: Re-elaboration + Queryable Completeness (closes scratchpad items F1 and F2; fulfils the aspirational Ideal State bullets added 2026-05-19)
