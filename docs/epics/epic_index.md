...
- [EPIC-005](./EPIC-005-v6-skills-and-claude-template.md) — ELABORATED — V6 Vocabulary in Skills and CLAUDE.md Template (FEAT-006) #v6 #framework
- [EPIC-006](./EPIC-006-work-item-lifecycle-maturation.md) — ELABORATED — Work Item Lifecycle Maturation: Re-elaboration + Queryable Completeness (FEAT-003) #framework #work-items
