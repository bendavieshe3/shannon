...
- [TASK-003](../tasks/TASK-003-apply-partial-completeness-affordance.md) — ELABORATED — Apply the queryable-completeness affordance to FEAT-003, FEAT-006 and FEAT-007 on real data; close F2 bullet 4 and the recursive-dogfood ACs. Created 2026-05-22 — the forward-declared follow-up Task described below, precondition now met.
