...
- **Vision update: add Lightweight Idea Capture as a Key Feature** — FEAT-007 was created 2026-05-18 to capture the scratchpad pattern as a Shannon capability, but Vision § Key Features doesn't currently list it. FEAT-007 has "Vision Reference: not yet in Vision; surfaces a Vision gap" as a deliberate placeholder. Next Vision review should add Lightweight Idea Capture to Key Features, then FEAT-007's Vision Reference can be updated #vision #feat-007
