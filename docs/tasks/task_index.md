...
- [TASK-009](./TASK-009-add-work-items-skill-prompts-and-resync-claude.md) — PLANNED — Add work-items skill prompts at § Process: Plan steps 2 and 3 + `.claude/` re-sync (EPIC-007 Task 2) #framework #work-items #skills #conventions
