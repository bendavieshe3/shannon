...
- [TASK-022](./TASK-022-shannon-goal-decomposition-skill.md) — DRAFT — Goal-Decomposition `/shannon-goal` Skill and Command (EPIC-010 Task 1) #supervisor #skill #command #goal-decomposition
