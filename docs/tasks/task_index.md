...
- [TASK-028](./TASK-028-per-category-finding-counts-in-report-header.md) — ELABORATED — Per-Category Finding Counts in the Report Header (EPIC-010 Task 7; sequenced before TASK-025) #supervisor #templates #report-pipeline #header #machine-readable
