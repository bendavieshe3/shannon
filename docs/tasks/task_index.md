...
- [TASK-004](./TASK-004-v6-vocabulary-setup-documentation-template.md) — ELABORATED — V6 vocabulary in project-setup & project-documentation skills + CLAUDE.md template (EPIC-005) #framework #v6 #skills
